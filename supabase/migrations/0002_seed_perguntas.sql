...
(4, 'logistica', 'dificil',
 'O método de reposição de estoque que calcula o Lote Econômico de Compra busca minimizar:',
 '[{"id":"a","texto":"O tempo de entrega do fornecedor"},{"id":"b","texto":"A soma dos custos de pedido e de manutenção de estoque"},{"id":"c","texto":"O número de fornecedores ativos"},{"id":"d","texto":"A variedade de SKUs"}]',
 'b',
 'O EOQ (Economic Order Quantity) equilibra custo de pedido (fazer pedidos com frequência) e custo de manter estoque (armazenagem, capital parado).'),

(5, 'pesqop', 'dificil',
 'Em Pesquisa Operacional, a Programação Linear é usada para:',
 '[{"id":"a","texto":"Prever séries temporais com redes neurais"},{"id":"b","texto":"Otimizar uma função objetivo sujeita a restrições lineares"},{"id":"c","texto":"Simular filas com distribuição de Poisson"},{"id":"d","texto":"Classificar dados em clusters"}]',
 'b',
 'Programação Linear maximiza ou minimiza uma função objetivo linear (ex.: lucro, custo) respeitando restrições lineares de recursos.'),
...
(13, 'economica', 'dificil',
 'Na Engenharia Econômica, o Valor Presente Líquido (VPL) de um projeto é usado para:',
 '[{"id":"a","texto":"Medir a satisfação dos funcionários"},{"id":"b","texto":"Trazer os fluxos de caixa futuros a valor presente e avaliar a viabilidade do investimento"},{"id":"c","texto":"Calcular o preço de venda de um produto"},{"id":"d","texto":"Determinar o número ideal de funcionários"}]',
 'b',
 'O VPL desconta os fluxos de caixa futuros por uma taxa mínima de atratividade (TMA); se positivo, o projeto agrega valor.'),

(14, 'economica', 'dificil',
 'A Taxa Interna de Retorno (TIR) de um projeto é a taxa de desconto para a qual:',
 '[{"id":"a","texto":"O payback é igual a zero"},{"id":"b","texto":"O Valor Presente Líquido (VPL) do projeto é igual a zero"},{"id":"c","texto":"O lucro contábil é máximo"},{"id":"d","texto":"O custo fixo se iguala ao custo variável"}]',
 'b',
 'TIR é a taxa que zera o VPL. Um projeto costuma ser atrativo quando a TIR supera a Taxa Mínima de Atratividade (TMA).'),
